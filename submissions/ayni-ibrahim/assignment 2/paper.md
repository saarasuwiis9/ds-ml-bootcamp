...
This dataset was collected manually through a survey among university students.
The survey asked students about their age, study hours, sleep hours, internet usage, and class attendance.
All responses were recorded manually. No pre-made datasets (like Kaggle or UCI) were used.
...
Features (X):
The dataset has 5 input variables (features):
...
This is the target variable we aim to predict using features.
